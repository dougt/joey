var XpiInstaller = {
	...
	extFullName: 'Joey', // The name displayed to the user (don't include the version)
	extShortName: 'joey', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Doug Turner',
